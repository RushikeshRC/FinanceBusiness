...
"use strict";
let files = [];
if (Umbraco.Sys.ServerVariables.Plumber.platform === 'CORE') {
    files = [
    ...
    files = [
        '/umbraco/lib/jquery/jquery.min.js',
        '/umbraco/lib/angular/angular.js',
        '/umbraco/lib/angular-route/angular-route.js',
        '/umbraco/lib/angular-sanitize/angular-sanitize.js',
        '/umbraco/lib/angular-ui-sortable/sortable.js',
        '/umbraco/lib/underscore/underscore-min.js',
        '/umbraco/lib/umbraco/Extensions.js',
        '/umbraco/js/app.js',
        '/umbraco/js/umbraco.resources.js',
        '/umbraco/js/umbraco.directives.js',
        '/umbraco/js/umbraco.filters.js',
        '/umbraco/js/umbraco.services.js',
        '/umbraco/js/umbraco.interceptors.js',
